        ...
        <div className={s.blog}>
          <div className={`${s.flexes} flex`} style={{ gap: "24px" }}>
            ...
            <div className={s.centerAdap}>
              ...
              <h6 className={s.none} onClick={() => setTime(!time)}>
        ...
        <div className={s.cards}>
          <div className="flex" style={{ gap: "24px" }}>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>Сначала старые</Typography>
              </AccordionDetails>
              <AccordionDetails>
                <Typography>Сначала цена меньше</Typography>
              </AccordionDetails>
              <AccordionDetails>
                <Typography>Сначала цена больше</Typography>
              </AccordionDetails>
            </Accordion>
            <button
              id={s.btn_orange}
