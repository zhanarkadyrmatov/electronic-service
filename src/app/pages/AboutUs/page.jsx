...
const check = [
  ...
  },
  {
    id:3,
    icon: '/img/check.svg',
    title:'Fveniam, quis nostrum rcitationem ullam corporis suscipit laboriosam,',
  },
  {
    id:4,
    icon: '/img/check.svg',
  ...
  },
  {
    id:5,
    icon: '/img/check.svg',
    title:'Stiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur'
  },
  {
    id:6,
    icon: '/img/check.svg',
        ...
        <div className={s.abouts}>
          <div className={`${s.arod} around`}>
            <div className={s.about_one}>
              <h1>О компании</h1>
              <h3>Lorem ipsum <span>dolor sit amet, <br />
                consectetur adipiscing elit.</span> Lacus,<br />
                purus pulvinar elit tellus massa erat <br />
                turpis congue.</h3>
              <div className="flex" style={{gap:'20px', padding:'30px 0'}}>
                <div className={s.border}></div>
                <p className={s.p}>Ut enim ad minima v quia non numquam eius modi <br />
              ...
              <div className={`${s.fleX} ${s.arod}`} style={{ gap: '40px' }}>
                ...
                <div>
                  <h2>547</h2>
                  <h6>Smodi tempora <br /> incidunt </h6>
                </div>
                <div>
                  <h2>1 474</h2>
                  <h6>Qia non numquam <br /> eius </h6>
                </div>
                <div>
                  <h2>1</h2>
                  <h6>Abore et dolore <br /> agnam</h6>
                </div>
              </div>
            </div>
            <div>
          ...
          <div className={s.lorem}>
            <div className={`${s.arod} between`}>
              ...
              <h2>Lorem ipsum <br /> <span>dolor sit <br />  adipiscing <br /></span> elitaa dwet </h2>
              <div className={s.border}></div>
              </div>
            <div className={s.grid}>
              {
